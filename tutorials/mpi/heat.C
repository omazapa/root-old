...
int heat( int argc=0, char *argv[]=0 )
...
//
{
  ...
  ROOT::Mpi::Init ( argc, argv );

  id = ROOT::Mpi::COMM_WORLD.Get_rank ( );

  p = ROOT::Mpi::COMM_WORLD.Get_size ( );
...
//
    ...
    {
      tag = 1;
      ROOT::Mpi::COMM_WORLD.Send ( &h[1], 1, ROOT::Mpi::DOUBLE, id-1, tag );
    }
//
...
//
    ...
    {
      tag = 1;
      ROOT::Mpi::COMM_WORLD.Recv ( &h[n+1], 1,  ROOT::Mpi::DOUBLE, id+1, tag, status );
    }
//
//  Send H[N] to ID+1.
//
    ...
    {
      tag = 2;
      ROOT::Mpi::COMM_WORLD.Send ( &h[n], 1, ROOT::Mpi::DOUBLE, id+1, tag );
    }
//
...
//
    ...
    {
      tag = 2;
      ROOT::Mpi::COMM_WORLD.Recv ( &h[0], 1, ROOT::Mpi::DOUBLE, id-1, tag, status );
    }
//
